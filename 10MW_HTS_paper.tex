...
\begin{figure}[]
  \centering
  \subfloat[Single cryostat.]{\label{single_cryostat}\includegraphics[scale=0.6]{single_cryostat}}  \hfill
...
The main losses in the machine are presented in \autoref{10MW_efficiency}, which are dominated by the copper loss\footnotepic{\url{large_wind/optimization_outputs/10MW_10rpm/calculate_power.R}}. 40 kW of air blowers are used for ventilation of armature coils. 
...
\begin{figure}[h!]
  ...
  \hfill
  %\subfloat[Inner rotor with single bearing.]{\label{structure2}\includegraphics[scale=1.2]{structure_claw_radial}}
